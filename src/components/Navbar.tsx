...
export const Navbar = () => {
      ...
      <span className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
        ...
        <div className="gap-3 nav__item mr-2 lg:flex ml-auto lg:ml-0 lg:order-2">
            ...
            <div className="hidden mr-3 lg:flex nav__item">
              <Link href="/" className="px-6 py-2 text-white bg-[#00bcb7] hover:bg-[#038A87] rounded-md md:ml-5">
                Get Started
              </Link>
            </div>
        </div>
  ...
  <div className="w-full">
    ...
    <Link href="/" className="w-full px-6 py-2 mt-3 text-center text-white bg-[#00bcb7] hover:bg-[#038A87] rounded-md lg:ml-5">
      Get Started
    </Link>
  </div>
</Disclosure.Panel>
